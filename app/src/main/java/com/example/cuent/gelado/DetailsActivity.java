...
import com.example.cuent.gelado.data.StockContract;
import com.example.cuent.gelado.data.StockItem;

public class DetailsActivity extends AppCompatActivity {

    //Declamos los atributos que hemos creado en el activty_details.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //los instanciamos con sus compomentes.
        ...
        //Descrementamos la cantidad (Stock) de los articulos
        ...
        //incremetamos la cantidad (Stock) de los productos
        ...
        //Asignamos la imagen al pulsar el boton Añadir imagen.
    ...
    public void onBackPressed() {
        ...
        // Mostamos el mensajde de que no han sido guardados los cambios al modificar.
        showUnsavedChangesDialog(discardButtonClickListener);
    }


    //Mostramos el mensaje al modificar si intentamos salir y no hemos pulsado el check!
    ...
    //Suamos la cantidad que hemos añadido a la anterior.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_order:
                // mostramos el telefono y mail por defecto.
                showOrderConfirmationDialog();
                return true;
            case R.id.action_delete_item:
                // Mostramos en el Actionbar la opcion para borrar un item
                showDeleteConfirmationDialog(currentItemId);
                return true;
            case R.id.action_delete_all_data:
                //Mostramos en el Actionbar la opcion para borrar todos los Items
    ...
    //En caso de no rellenar alguno de los campos montrar un error para rellenarlo.
    ...
    //Añadimos los valores modificados a la BD.
    ...
    //La opcion para realizar un pedido (por telefono o E-mail)
    ...
    //Metodo que nos confirma si queremos borrar un Item de la BD.
    ...
    //Para dar permisos al dispositivo.
    @Override
    public void onRequestPermissionsResult(int requestCode,
                                           String permissions[], int[] grantResults) {
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE: {
                //si el permiso es cancelado, el resultado de los arrays estara vacio.
    ...
    //Metodo para coger la imagen de la galeria del dispositivo y guardarla en la BD.
    @Override
